...
STATE_MATRIX: list[dict[str, Any]] = [
    ...
    {"state": "NY", "name": "New York", "portal_name": "NYS Contract Reporter / BidNet", "list_url": "https://www.bidnetdirect.com/new-york", "platform_family": PLATFORM_BIDNET, "adapter_family": "live_bidnet", "publicly_searchable": True, "docs_public": True, "auth_required": False, "adapter_status_seed": ADAPTER_UNVERIFIED_LIVE, "restrictions": "BidNet Direct NY public listing; some package views may require free registration", "validation_candidate": True},
